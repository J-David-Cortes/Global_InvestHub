<?php
    class fecha_fin {
        ...
        public function consulta(){
            // Corregido: FORM -> FROM y ordenado por fecha
            $sql = "SELECT * FROM fecha_fin ORDER BY fecha";
            $res = mysqli_query($this->conexion, $sql) or die("No se pudo consultar la tabla fecha_fin");
