-- Migracion: datos geograficos reales de Colombia (pais/departamento/ciudad).
--
-- Origen del dato: archivos departamentos.sql y municipios.sql compartidos
-- por el profesor de SENA (repositorio "departamentos-y-municipios-colombia-SQL"),
-- dataset original del DANE (Departamento Administrativo Nacional de
-- Estadistica), año 2012. Los IDs de departamento y municipio/ciudad son
-- los codigos oficiales del DANE (no son consecutivos).
--
-- *** IMPORTANTE: forzar utf8mb4 en la conexion antes de ejecutar este
-- *** archivo. NO confiar en el "SET NAMES utf8" del dump original del
-- *** profesor (es de 2016, con la codificacion legada de 3 bytes).
-- *** Verificado: los bytes fuente de departamentos.sql/municipios.sql son
-- *** UTF-8 real (ej. 'Á' = 0xC3 0x81, UTF-8 correcto).
--
-- Transformaciones aplicadas respecto al archivo original del profesor:
--   1. El archivo original no tiene tabla "pais" (asume que todo es
--      Colombia). Se agrega 1 fila en "pais" primero, y su id se usa
--      como fo_pais para cada departamento (variable @id_pais_co).
--   2. Tabla "departamentos" (plural, columna "departamento") -> tabla
--      real "departamento" (columna "nombre" + fo_pais nuevo).
--   3. Tabla "municipios" (columna "municipio", con columna "estado" que
--      no existe en nuestro esquema) -> tabla real "ciudad" (columna
--      "nombre" + fo_departamento), descartando la columna "estado".
--   4. Se quitan las sentencias propias del dump (DROP/CREATE TABLE,
--      LOCK/UNLOCK, DISABLE/ENABLE KEYS) porque nuestras tablas ya
--      existen con su estructura real -- solo se conservan los datos.
--   5. Se conservan los IDs explicitos del DANE (no consecutivos) en vez
--      de dejar que AUTO_INCREMENT asigne los suyos, para no tener que
--      remapear las referencias departamento->ciudad.
--
-- Orden de ejecucion obligatorio (FK reales activas, a diferencia del
-- dump original que traia FOREIGN_KEY_CHECKS=0): pais -> departamento -> ciudad.
--
-- Plan de ejecucion acordado: se ejecuta primero SOLO el bloque de "pais"
-- y se verifica antes de continuar con los ~1133 inserts restantes.

-- ============================================================
-- BLOQUE 1: pais
-- ============================================================
INSERT INTO pais (nombre) VALUES ('Colombia');
SET @id_pais_co = LAST_INSERT_ID();

-- ============================================================
-- BLOQUE 2: departamento (33 filas, codigos DANE)
-- ============================================================
INSERT INTO departamento (id_departamento, nombre, fo_pais) VALUES
	(5,'ANTIOQUIA',@id_pais_co),
	(8,'ATLÁNTICO',@id_pais_co),
	(11,'BOGOTÁ, D.C.',@id_pais_co),
	(13,'BOLÍVAR',@id_pais_co),
	(15,'BOYACÁ',@id_pais_co),
	(17,'CALDAS',@id_pais_co),
	(18,'CAQUETÁ',@id_pais_co),
	(19,'CAUCA',@id_pais_co),
	(20,'CESAR',@id_pais_co),
	(23,'CÓRDOBA',@id_pais_co),
	(25,'CUNDINAMARCA',@id_pais_co),
	(27,'CHOCÓ',@id_pais_co),
	(41,'HUILA',@id_pais_co),
	(44,'LA GUAJIRA',@id_pais_co),
	(47,'MAGDALENA',@id_pais_co),
	(50,'META',@id_pais_co),
	(52,'NARIÑO',@id_pais_co),
	(54,'NORTE DE SANTANDER',@id_pais_co),
	(63,'QUINDIO',@id_pais_co),
	(66,'RISARALDA',@id_pais_co),
	(68,'SANTANDER',@id_pais_co),
	(70,'SUCRE',@id_pais_co),
	(73,'TOLIMA',@id_pais_co),
	(76,'VALLE DEL CAUCA',@id_pais_co),
	(81,'ARAUCA',@id_pais_co),
	(85,'CASANARE',@id_pais_co),
	(86,'PUTUMAYO',@id_pais_co),
	(88,'ARCHIPIÉLAGO DE SAN ANDRÉS, PROVIDENCIA Y SANTA CATALINA',@id_pais_co),
	(91,'AMAZONAS',@id_pais_co),
	(94,'GUAINÍA',@id_pais_co),
	(95,'GUAVIARE',@id_pais_co),
	(97,'VAUPÉS',@id_pais_co),
	(99,'VICHADA',@id_pais_co)
;

-- ============================================================
-- BLOQUE 3: ciudad (1100 filas -- municipios del DANE, columna
-- "estado" del archivo original descartada)
-- ============================================================
